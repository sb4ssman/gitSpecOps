...
```powershell
python git-sync-suggester/sync_suggester.py fleet connect --server http://100.x.y.z:8765 --root "T:\Github" --acknowledge-initial-scan
```
...
The desktop-preview PyInstaller recipe is documented in [BUILD-DESKTOP.md](BUILD-DESKTOP.md).
